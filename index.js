const _symbols = require('unicode/category/So');
...
function slug(string, opts) {
  ...
  if (typeof opts.replaceSymbols === 'undefined') { opts.replaceSymbols = defaults.replaceSymbols; }
  ...
  for (var char, i = 0, l = string.length; i < l; i++) {
    ...
    if (!lengths.some((len) => {
      ...
      if (opts.replaceSymbols && (unicode = _symbols[code])) {
